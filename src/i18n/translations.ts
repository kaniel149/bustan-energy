...
const en = {
  ...
  crm: {
    ...
    dash: {
      ...
      dealFunnel: 'Deal Flow Funnel',
      funnelScans: 'Scans run', funnelCandidates: 'Candidates found',
      funnelApproved: 'Approved leads', funnelContact: 'Has contact',
      funnelProposal: 'Proposal sent', funnelSigned: 'Signed / Won',
      ofPrev: 'of prev.',
    },
    ...
    map: {
      ...
      quickPreviewUntracked: 'Quick Preview (untracked)',
...
const th = {
  ...
  crm: {
    ...
    map: {
      ...
      createProposal: 'สร้างใบเสนอราคา',
      quickPreviewUntracked: 'ดูตัวอย่างเร็ว (ไม่ติดตาม)',
...
const he = {
  ...
  crm: {
    ...
    dash: {
      ...
      dealFunnel: 'משפך עסקאות',
      funnelScans: 'סריקות שנעשו', funnelCandidates: 'מועמדים שנמצאו',
      funnelApproved: 'לידים שאושרו', funnelContact: 'יש איש קשר',
      funnelProposal: 'הצעה נשלחה', funnelSigned: 'נחתם / נסגר',
      ofPrev: 'מהשלב הקודם',
    },
    ...
    map: {
      ...
      createProposal: 'צור הצעת מחיר',
      quickPreviewUntracked: 'תצוגה מהירה (לא עוקב)',
