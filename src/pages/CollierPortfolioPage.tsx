...
// ---------------------------------------------------------------------------
// Tier colour system — mirrors map legend priority colours from FilterBar/PlatformPage
...
// Top N entries from a Record, sorted descending by count
...
// Summary stat card — matches AdminDashboardPage StatCard pattern
function StatCard({
  label,
  value,
  sub,
...
// Tier stat card with coloured value
...
function ListingRow({ listing }: { listing: CollierListing }) {
  ...
  return (
    <tr className="border-b border-white/5 hover:bg-white/[0.03] transition-colors group">
      ...
      {/* Est kWp — labeled as preliminary */}
...
// ---------------------------------------------------------------------------
// Top 15 card (meeting-ready section)
// ---------------------------------------------------------------------------
...
function Top15Card({ listing, rank }: { listing: CollierListing; rank: number }) {
  ...
  return (
    <div
      className="bg-white/5 rounded-xl border border-white/10 p-4 hover:bg-white/[0.07] transition-colors flex flex-col gap-2"
    >
      ...
      {/* Est kWp — prominently labeled preliminary */}
      <div
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#0A1628] text-white">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/40">
                  Demo · {summary.total} listings · TM Energy
                </p>
              </div>
            </div>
        ...
        {/* Page footer */}
        <footer className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6 text-center">
