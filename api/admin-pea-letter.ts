...
<div class="letter-section" lang="th">
  ...
  <div class="body-text">
    ...
    <table class="specs-table">
      ...
      <tr><td>ประเภทการเชื่อมต่อ</td><td>ระบบผูกกับสายส่ง (Grid-tied) ขายไฟฟ้าส่วนเกิน</td></tr>
    </table>
...
<div class="letter-section" lang="en">
  ...
  <div class="body-text">
    ...
    <table class="specs-table">
      ...
      <tr><td>Connection Type</td><td>Grid-tied, net metering / excess export</td></tr>
...
<head>
<meta charset="UTF-8">
<title>${title} — TM Energy / ${esc(p.proposal_ref || p.project_id || 'Draft')}</title>
<style>
...
<div class="letterhead">
  ...
  <div class="company-info">
    TM Energy Co., Ltd. · Koh Phangan, Surat Thani 84280 · Thailand<br>
...
<div class="footer-note">
  Document generated by TM Energy system · Proposal Ref: ${esc(p.proposal_ref || '—')} ·
  For internal use only — print and obtain wet-ink signatures before submission to ${branch.authority}.
</div>
